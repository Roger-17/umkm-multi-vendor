...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('assets/images/Yumeuli.ico') }}">
    <link rel="icon" href="{{ asset('assets/images/Yumeuli.ico') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('assets/images/Yumeuli.ico') }}" type="image/x-icon">
    <meta name="theme-color" content="#e87316">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="Surfside Media">
    <meta name="msapplication-TileImage" content="{{ asset('assets/images/Yumeuli.ico') }}">
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{ route('home') }}" class="nav-link menu-title">Beranda</a>
                                            </li>
                                            <li><a href="{{ route('shop') }}" class="nav-link menu-title">Produk</a>
                                            </li>

                                            {{-- <li><a href="contact-us.html" class="nav-link menu-title">UMKM</a></li> --}}
                                            <li><a href="blog.html" class="nav-link menu-title">Contact Us</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
                                                    ...
                                                    @else
                                                        <li>
                                                            <a href="{{ route('dashboard_customer') }}"
                                                                class="d-block">Dashboard Customer</a>
                                                        </li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> (+62) 8977883383 </span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Jl. Ciganitri No.1 Bojongsoang,
                                            Bandung, Jawa Barat 40287 Desa Lengkong Kec. Bojongsoang Kab.
                                            Bandung</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light">
                                            desalengkong1925@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        {{-- <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2023, Abdimas.</p>
                    </div>
                </div>
            </div>
        </div> --}}

                                    ...
                                    <div class="page-view-filter">
                                        <div class="dropdown select-featured">
                                            <select class="form-select" name="orderby" id="orderby">
                                                <option value="-1" {{ $produk==-1? 'selected':'' }}>Default</option>
                                                <option value="1"{{ $produk==1? 'selected':'' }}>Pembaruan, Terbaru</option>
                                                <option value="2"{{ $produk==2? 'selected':'' }}>Pembaruan, Terlama</option>
                                                <option value="3"{{ $produk==3? 'selected':'' }}>Harga, Terendah</option>
                                                <option value="4"{{ $produk==4? 'selected':'' }}>Harga, Tertinggi</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="dropdown select-featured">
